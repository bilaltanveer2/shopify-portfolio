...
import { ExternalLink, Github, ShoppingCart, TrendingUp, Globe, Smartphone } from "lucide-react";

const ProjectsSection = () => {
  const projects = [
    {
      title: "Tamween Mart - Grocery E-commerce Store",
      description: "Complete Shopify store for grocery and daily essentials with custom theme, user-friendly navigation, and optimized checkout process.",
    ...
    },
    {
      ...
      description: "The Shopping Centr is a fully responsive Shopify store developed as part of an eCommerce project. It features a sleek product catalog, optimized user experience, and seamless payment integration.",
      tech: ["Shopify", "Liquid", "JavaScript", "Meta Pixel"],
      category: "E-commerce",
      icon: ShoppingCart,
      metrics: { conversion: "+40%", revenue: "+150%", traffic: "+200%" },
    ...
    },
    {
      ...
      description: "Cross-platform mobile e-commerce app with real-time inventory, push notifications, and social commerce features.",
              ...
              <Card key={index} className="shadow-elegant hover:shadow-glow transition-all duration-300 group">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex gap-3 pt-4">
                    {/* Inside the CardContent, update the buttons */}
...
// Inside the Card component, after CardHeader
